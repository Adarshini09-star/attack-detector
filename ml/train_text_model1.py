...
Usage (from project root): python ml/train_text_model.py
Usage (from inside ml/):   python train_text_model.py
"""
...
# Always save next to THIS file, regardless of where you run from
...
# ── SAVE — always writes into the same folder as this script ──
...
print(f"✅ Saved: {HERE / 'text_model.pkl'}")
print(f"✅ Saved: {HERE / 'vectorizer.pkl'}")